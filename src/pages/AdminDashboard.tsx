    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          { label: 'Active Subjects', value: stats.activeSubjects, icon: BookOpen, color: 'text-purple-600', bg: 'bg-purple-500/10', trend: 'Current semester', path: '/subjects' },
        ].map((stat, i) => (
          <motion.div
            key={stat.label}
            variants={itemVariants}
            ...
            className={cn(
              "bg-white/60 backdrop-blur-xl p-12 rounded-[3.5rem] border border-white/40 shadow-xl group transition-all",
